...
class OrderService {
  ...
  public async createOrder(input: CartItem[]): Promise<OrderWithDetails> {
    try {
  ...
  public async getMyOrders(input: OrderInquiry): Promise<OrderWithDetails[]> {
    try {
  ...
  public async updateOrder(input: OrderUpdateInput): Promise<OrderWithDetails> {
    try {
